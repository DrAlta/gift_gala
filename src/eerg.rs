...
use super::util::*;
pub trait EERGAgent<C: Commodity> {
    fn determine_purchase_quantity<M: Market<C>>(&self, bazaar:&M, commodity: &C) -> i32;
    fn determine_sale_quantity<M: Market<C>>(&self, bazaar:&M, commodity_id: &C) -> i32;
}
impl<T: MarketAgentBasics<C>, C: Commodity> EERGAgent<C> for T {
    fn determine_sale_quantity<M: Market<C>>(&self, bazaar:&M, commodity_id: &C) -> i32 {
